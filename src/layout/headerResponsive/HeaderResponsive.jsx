        ...
        <div className={`${style.header_box} ${style.header_sticky}`}>
            ...
            <div className={style.header}>
                ...
                <div className={style.header_right}>
                    <div className={style.header_right_Box} onClick={() => navigate('/likedPage')}>
                    <span className={style.header_right_BoxCartCount}>{likedCount}</span><RiHandHeartFill />Liked</div>
                ...
                <div ref={menuRef} className={style.header_right_responsive_box}>
                    <div className={style.header_right_responsive_box_card}>
                        <div className={`${style.header_right_Box_res} ${resSearchBox ? "" : style.header_main_searchBox_serchBar_res_displayBlock}`} onClick={clickResSearchBar}><CiSearch />Search</div>
                        <div className={style.header_right_Box} onClick={() => navigate('/yourCart')}>
                        <span className={style.header_right_BoxCartCount_res}>{productCount}</span>
                            <GrCart />Cart</div>
                    </div>
                </div>
            </div>
